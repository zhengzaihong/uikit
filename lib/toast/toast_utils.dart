...
class Toast {
  ...
  ToastConfig(buildToastWidget: (context, msg) {
    return Container(
        width: MediaQuery
            .of(context)
            .size
  ...
  ///外部设置一个弹出样式
  static set setGlobalToastConfig(ToastConfig config) =>
      _globalToastConfig = config;
  ...
  static void show(
              ...
              child: Container(
                  ...
                  child: Padding(
                    ...
                    child: AnimatedOpacity(
                      ...
                      child: _showing
                          ? _toastConfig?.buildToastWidget(context, msg)
                          : const SizedBox(),
                    ),
                  )),
            ));
    ...
    if (DateTime
        ...
        .difference(_startedTime!)
        .inMilliseconds >=
        ((_toastConfig == null) ? 1000 : _toastConfig!.showTime)) {
      _showing = false;
